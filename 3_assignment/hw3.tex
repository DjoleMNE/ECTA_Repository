...
\item
	\includegraphics[scale=0.5]{img/fitnessGA.png}
	\includegraphics[scale=0.6]{img/GA5.png}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item
		\includegraphics[scale=0.5]{img/ESvsCMAE.png}	
	\end{itemize}
	...
	\item	\includegraphics[scale=0.5]{img/CMAvsCMAEnoep.png}
		\item \color{blue}\textit{Performance of CMAES-without EP, for a single run with 200 generations}	\item \includegraphics[scale=0.5]{img/CMAES-withoutEP.png}
		\item \color{blue}\textit{Performance of CMAES-with EP, for a single run with 200 generations}	\item \includegraphics[scale=0.5]{img/CMAES-withEP.png}
...
\begin{enumerate}
	...
	\item
	\includegraphics[scale=0.5]{img/finalplotComparison.png}
\end{enumerate}
