...
function output = ff_ANN(input_vector, num_hidden, num_output)
...
wActive = zeros(nNode);
wActive(1 : num_input, num_input : num_input + num_hidden) = 1; % In to Hidden connections
wActive(num_input : num_input + num_hidden,...
        num_input + num_hidden : num_input + num_hidden + num_output) = 1; % Hidden to Out connections
